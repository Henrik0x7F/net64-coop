...
private:
    ...
    static const std::unordered_map<TKey, FactoryType>& get_factories()
    {
        return Shared::get_factories();
    }
...
public:
    ...
    [[nodiscard]]
    static TPtr make(const TKey& key, TArgs&&... args)
    {
    ...
    [[nodiscard]]
    static TPtr make(std::string_view key, TArgs&&... args)
    {
